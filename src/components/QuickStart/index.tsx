...
henrybarreto/bethrou-node:latest`,
    ...
    },
    {
        ...
        description: 'Retrieve the node\'s Peer ID and multiaddr from container logs',
        why: 'You need the node\'s unique identifier and address to configure the client. The Peer ID and multiaddr tell the client exactly where and how to reach your node.',
        code: `docker logs bethrou-node | grep -E "(Peer ID|Listening)"`,
        expectedOutput: `Output should show:
"Peer ID" id=12D3KooWRmF8HJnQyW4pqVx9Tz7J8mN5kL3pQrS...
"Listening on" addrs="[/ip4/127.0.0.1/tcp/4000 /ip4/172.17.0.2/tcp/4000]"
`
    },
    {
        number: 4,
        title: 'Create client.yaml',
        description: 'Configure the client with your node\'s connection details',
        why: 'The client needs to know how to connect to your exit node. The client.yaml file contains the node\'s Peer ID and multiaddr in the correct format.',
        code: `cat > client.yaml << 'EOF'
key: "network.key"
...
nodes:
  - id: <NODE PEER ID FROM STEP 3>
    addrs:
      - <MAADDR FROM STEP 3, e.g. /ip4/172.17.0.2/tcp/4000/p2p/<NODE PEER ID>>
...
log:
  ...
  format: text
EOF`,
        expectedOutput: 'A client.yaml file is created with your node\'s Peer ID and address. Replace the placeholder IDs with values from step 3.'
    },
    {
        number: 5,
